...
namespace WebApplicationTravel.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CityId,CityName,CountryId,FlightPriceKey,CarRentalPriceKey")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CityId,CityName,CountryId,FlightPriceKey,CarRentalPriceKey")] City city)
        {
            if (ModelState.IsValid)
            {
