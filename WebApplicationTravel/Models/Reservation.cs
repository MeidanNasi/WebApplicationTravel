...
namespace WebApplicationTravel.Models
{
    public class Reservation
    {
        ...
        public Reservation(LinkedList<string> path)
        {
        ...
        public void updateResAtAccount(Account a)
        {
            ...
            myReservation.AddLast("Total Price: " + this.totalPrice+"$ ,Total Duration: "+this.totalTime);
            a.Reservations.AddLast(myReservation);
        }
    }
}